...
function showDeleteModal(id, name){	
	...
	`
		<div class="modal-header">
			<h1 class="modal-title fs-5" id="deleteContactModalLabel">Are you sure you want to remove contact  [${name}]?</h1>
		</div>
		<div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
			  <input type="submit" class="btn btn-primary" data-bs-dismiss="modal" onclick="deleteContact(${id});" value="Delete Contact">
          </div>
	`;
